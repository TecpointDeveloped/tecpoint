...
function NavbarMenu() {
  return (
    <nav className="flex flex-col h-fit items-center justify-between fixed bg-[#1b1b1bd3] text-white w-full py-4 m-auto z-10">
      <section className="flex items-center justify-between w-full 2xl:w-[1900px] md:px-24">
