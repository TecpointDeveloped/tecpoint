    ...
    <>
      ...
      <main className="p-4 flex flex-col gap-6 md:w-[90%] m-auto mt-[70px]">
        ...
        <section>
          ...
          <p>
            Este sitio web es operado por Inversiones ELI-EZER S de RL de CV con nombre comercial Tecpoint. En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a Inversiones ELI-EZER S de RL de CV con nombre comercial Tecpoint ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
          </p>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold">Términos de la tienda en línea</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold">Exactitud, exhaustividad y actualidad de la información</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold">Modificaciones al servicio y precios</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold">Enlaces de terceras partes</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold">Comentarios de usuarios, captación y otros envíos</h2>
          <p>
        ...
        <section>
          ...
          <h2 className="text-xl font-semibold">Errores, inexactitudes y omisiones</h2>
          <p>
        ...
        <section>
          ...
          <p>
            Aceptas indemnizar, defender y mantener indemne Inversiones ELI-EZER S de RL de CV y nuestras matrices, subsidiarias, afiliados, socios, funcionarios, directores, agentes, contratistas, concesionarios, proveedores de servicios, subcontratistas, proveedores, internos y empleados, de cualquier reclamo o demanda, incluyendo honorarios razonables de abogados, hechos por cualquier tercero a causa o como resultado de tu incumplimiento de las Condiciones de Servicio o de los documentos que incorporan como referencia, o la violación de cualquier ley o de los derechos de un tercero.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold">Divisibilidad</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold">Rescisión</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold">Acuerdo completo</h2>
          <p>
        ...
        <section>
          ...
          <p>
            Plazo Disponemos de un plazo para devoluciones de a partir de la fecha en que la paquetería entregó tu pedido en el domicilio indicado al realizar la compra. Debes notificar acerca de la devolución antes de que se cumplan los a través de alguno de nuestros canales de atención:
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            – Estar sin usar y en las mismas condiciones en que lo recibiste. También debe estar en su embalaje original. Hay algunas situaciones donde solo se pueden garantizar reembolsos parciales:
          </p>
          <p>
            – Cualquier producto que no se encuentre en su condición original, que esté dañado o le falten partes por razones ajenas a nosotros.
          </p>
          <p>
        ...
        <section>
          <h3 className="text-lg font-medium">Productos que aplican</h3>
          <p>
            Se hacen devolucion por garantias en todos los productos que distribuye Tecpoint.
          </p>
        </section>

        <section>
          <h3 className="text-lg font-medium">Plazo de respuesta</h3>
          <p>
        ...
        <section>
          <h3 className="text-lg font-medium">Costos de envío</h3>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold">Ley</h2>
          <p>
        ...
        <section>
          ...
          <p>
            Preguntas acerca de los Términos de Servicio deben ser enviadas a sac@eli-ezer.net.
          </p>
          <p>
            Última actualización de este documento de términos y condiciones: 27/07/2023
          </p>
        </section>
      </main>
      <Footer />
