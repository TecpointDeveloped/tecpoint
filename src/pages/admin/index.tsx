...
const modules = [
  ...
  { href: "/admin/categorias", label: "Campañas", title: "Categorías y colecciones", copy: "Cree colecciones comerciales y copie enlaces listos para los botones de banners." },
