...
function My_Acoount() {
  ...
  return (
    <main className="bg-[#f7f7f7] h-screen p-4 flex justify-center items-start">
      <Head>
      ...
      <Tabs defaultValue="account" className="w-[400px] h-fit flex flex-col items-center">
        ...
        <TabsContent className="pt-4" value="account">
          <section className="flex flex-col items-center justify-center gap-8">
            {/* <div className="bg-black p-1 rounded-xl size-fit">
              <Image alt="logo tecpoint" src="/favicon.ico" height={50} width={50} />
            </div> */}
